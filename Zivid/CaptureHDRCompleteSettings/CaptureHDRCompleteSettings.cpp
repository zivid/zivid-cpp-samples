...
int main()
{
    try
    {
        ...
        camera << Zivid::Settings::Iris{ 10U } << Zivid::Settings::ExposureTime{ std::chrono::microseconds{ 10000 } }
               << Zivid::Settings::Brightness{ 1 } << Zivid::Settings::Gain{ 1 }
        ...
        camera << Zivid::Settings::Iris{ 20U } << Zivid::Settings::ExposureTime{ std::chrono::microseconds{ 20000 } }
               << Zivid::Settings::Brightness{ 0.5 } << Zivid::Settings::Gain{ 2 }
               << Zivid::Settings::Bidirectional{ false } << Zivid::Settings::Filters::Contrast::Enabled::yes
               << Zivid::Settings::Filters::Contrast::Threshold{ 5 } << Zivid::Settings::Filters::Gaussian::Enabled::yes
               << Zivid::Settings::Filters::Gaussian::Sigma{ 1.5 } << Zivid::Settings::Filters::Outlier::Enabled::yes
               << Zivid::Settings::Filters::Outlier::Threshold{ 5 }
        ...
        camera << Zivid::Settings::Iris{ 30U } << Zivid::Settings::ExposureTime{ std::chrono::microseconds{ 33000 } }
               << Zivid::Settings::Brightness{ 1 } << Zivid::Settings::Gain{ 1 }
               << Zivid::Settings::Bidirectional{ true } << Zivid::Settings::Filters::Contrast::Enabled::yes
               << Zivid::Settings::Filters::Contrast::Threshold{ 5 } << Zivid::Settings::Filters::Gaussian::Enabled::yes
               << Zivid::Settings::Filters::Gaussian::Sigma{ 1.5 } << Zivid::Settings::Filters::Outlier::Enabled::yes
               << Zivid::Settings::Filters::Outlier::Threshold{ 5 }
               << Zivid::Settings::Filters::Reflection::Enabled::yes
